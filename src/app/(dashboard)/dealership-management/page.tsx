...
// import DealershipDetailsModal from "./_components/DealershipDetailsModal";
...
const page = () => {
  return (
    <div className='text-green-500 text-4xl text-center font-serif  font-bold'>
      Comming soon
    </div>
  )
}
